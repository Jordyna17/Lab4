...
public class Pokemon {
    ...
    /**
     *
     * @param pokename Pokemon's name
     * @param levelhit Pokemon's hit level
     * @param levelattack Pokemon's attack level
     * @param leveldefense Pokemon's defense level
     */
    public Pokemon(final String pokename, final int levelhit, final int levelattack, final int leveldefense) {
